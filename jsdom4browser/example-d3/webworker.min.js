...
var sum = 0;
for (var i = 0; i < 100000; i++) {
    for (var f = 0; f < 15000; f++) {
       sum++;
    };
};

function act(scenario) {
  var a = d3.select(window.document.body).selectAll('div');
...
postMessage(window.document.body.innerHTML);
